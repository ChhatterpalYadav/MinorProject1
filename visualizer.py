...
class ConfigDialog(QDialog):
    def __init__(self):
        ...
        self.setWindowTitle("Welcome JIIT Student")
        self.setWindowIcon(QIcon("favicon.ico"))
 
        self.setFixedSize(1000,500)  # Adjust size as needed
 
        layout = QVBoxLayout(self)

        com_layout = QHBoxLayout()
        self.com_label = QLabel('Choose Your COM Port:', self)
        com_layout.addWidget(self.com_label)
        self.com_select = QComboBox(self)
        self.com_select.setFixedSize(200, 50)  
        ...
        self.amp_select.setFixedSize(200, 50)  # Set fixed size for Amplitude selection
        ...
        self.ch_select.setFixedSize(200, 50)  # Set fixed size for Channel selection
        ...
        self.sec_select.setFixedSize(200, 50)  # Set fixed size for Seconds selection
        ...
        self.ok_button.setFixedSize(200, 60)  # Set fixed size for OK button
