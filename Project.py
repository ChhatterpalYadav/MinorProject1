...
def generate():
    ...
    root1.title("ChatGPT Project Idea Generator")
    ctk.set_appearance_mode("dark")
    title_label = ctk.CTkLabel(root1, text="Project Idea Generator", 
    ...
    result = ctk.CTkTextbox(root1, font=ctk.CTkFont(size=15))
